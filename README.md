...
<div align="center">
    ...
    <a href="https://arxiv.org/abs/"><strong>HF Demo</strong></a>
</div>
...
## Results
![DEMO](./assets/vis_real3d_compressed.mp4)
...
Then, download the [model weight]() and put it to `./checkpoints/model_both_v1.ckpt`.


## Demo
Use `./run.sh` and modify your image path and foreground segmentation config accordingly.
